...
select tb_produto.nome, tb_produto.marca, tb_categoria.departamento from tb_produto inner join tb_categoria on tb_categoria.id=tb_produto.departamento_id;

select tb_produto.nome, tb_produto.marca, tb_categoria.departamento from tb_produto inner join tb_categoria on tb_categoria.id=tb_produto.departamento_id where departamento = "Dermocosméticos";
